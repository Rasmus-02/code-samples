...
def generate_launch_description():
    ...
    pkg_my_world = get_package_share_directory('group_25_navigation_stack') # TODO: your package name
    ...
    world = os.path.join(pkg_my_world, 'worlds', 'World.world') # TODO: fill the name of your cutom world
    print(world)
